...
MainWindow::MainWindow(Simulateur &S, QWidget *parent) : QMainWindow(parent)
{
    s = S;
  ...
  //  m_customBtn = new CustomButton(this);
   ...
   //Connection boutons et classe -> Ouvrir et Fermer d'une Vanne
...
void  MainWindow::OnOffVanneVT12(){  qDebug()<<"test"<< endl;
                                     s.infoVanneVT12(); }
